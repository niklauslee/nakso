...
function ArrowheadIcon({
  ...
  switch (value) {
    case LineEndType.FLAT:
      return (
        <LineEndFlatIcon size={16} strokeWidth={1.5} className={className} />
      );
    case LineEndType.ARROW:
      return (
        <LineEndArrowIcon size={16} strokeWidth={1.5} className={className} />
      );
    ...
    case LineEndType.DIAMOND:
      return (
        <LineEndDiamondIcon size={16} strokeWidth={1.5} className={className} />
      );
    ...
    case LineEndType.PLUS:
      return (
        <LineEndPlusIcon size={16} strokeWidth={1.5} className={className} />
      );
    case LineEndType.CIRCLE:
      return (
        <LineEndCircleIcon size={16} strokeWidth={1.5} className={className} />
      );
    ...
    case LineEndType.CROSS:
      return (
        <LineEndCrossIcon size={16} strokeWidth={1.5} className={className} />
      );
    case LineEndType.DOT:
      return (
        <LineEndDotIcon size={16} strokeWidth={1.5} className={className} />
      );
    case LineEndType.BAR:
      return (
        <LineEndBarIcon size={16} strokeWidth={1.5} className={className} />
      );
    case LineEndType.SQUARE:
      return (
        <LineEndSquareIcon size={16} strokeWidth={1.5} className={className} />
      );
    default:
      return (
        <LineEndFlatIcon size={16} strokeWidth={1.5} className={className} />
